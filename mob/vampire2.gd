...
const ORBIT_RADIUS      : float = MobStats.VAMPIRE2_ORBIT_RADIUS
const ORBIT_SPEED       : float = MobStats.VAMPIRE2_ORBIT_SPEED
const DASH_SPEED        : float = MobStats.VAMPIRE2_DASH_SPEED
const DASH_DURATION     : float = MobStats.VAMPIRE2_DASH_DURATION
const RECOVER_DURATION  : float = MobStats.VAMPIRE2_RECOVER_DURATION
const DASH_INTERVAL_MIN : float = MobStats.VAMPIRE2_DASH_INTERVAL_MIN
const DASH_INTERVAL_MAX : float = MobStats.VAMPIRE2_DASH_INTERVAL_MAX
...
func _ready() -> void:
	max_health      = MobStats.VAMPIRE2_MAX_HEALTH
	personality     = Personality.WANDER
	aggro_radius    = MobStats.VAMPIRE2_AGGRO_RADIUS
	damage          = MobStats.VAMPIRE2_DAMAGE
	knockback_force = MobStats.VAMPIRE2_KNOCKBACK

	super._ready()
	collision_mask = 0
	_apply_hitbox(MobStats.VAMPIRE2_HITBOX_RADIUS)
	z_index = 4
