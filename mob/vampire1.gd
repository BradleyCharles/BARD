...
const ASSET_BASE         : String = "res://assets/mobs/Vampire1/"
...
const DASH_INTERVAL_MIN  : float  = 3.0
const DASH_INTERVAL_MAX  : float  = 5.0
...
func _build_sprite_frames() -> void:
	...
	for anim: String in ["Idle", "Run", "Run_attack", "Hurt", "Death"]:
		for dir: String in ["front", "back", "left", "right"]:
			...
			var path := "%s%s/Vampire1_%s_%s.aseprite" % [ASSET_BASE, anim, anim, dir]
